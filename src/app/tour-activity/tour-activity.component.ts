...
@Component({
  selector: 'app-tour-activity',
  templateUrl: './tour-activity.component.html',
  styleUrls: ['./tour-activity.component.css']
})
export class TourActivityComponent implements OnInit {
